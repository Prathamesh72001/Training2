...
class StudentAdapter(val list:ArrayList<StudentHelperClass>):RecyclerView.Adapter<StudentAdapter.customViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StudentAdapter.customViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.uri_layout, parent, false)

        return customViewHolder(view)
    }

    override fun onBindViewHolder(holder: StudentAdapter.customViewHolder, position: Int) {
